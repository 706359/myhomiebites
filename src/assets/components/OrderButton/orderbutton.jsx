...
const calcCount = (cart) => {
	...
	if (typeof cart === 'object') return Object.values(cart).reduce((s, v) => s + (Number(v) || 0), 0);
	return 0;
};
...
export default function OrderButton({ updateQty }) {
	...
	return (
		<>
			...
			{open && <OrderModal closeModal={() => setOpen(false)} cart={itemsSelected} updateQty={updateQty} />}
		</>
	);
}
