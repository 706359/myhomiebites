		...
		<footer>
			<div className='footer-inner'>
				...
				<div className='footerButtons'>
					...
					<a className='btn btn-primary pulse' href='https://wa.me/916395559255' target='_blank' rel='noopener noreferrer' aria-label='Order Now on WhatsApp'>
						Order Now
					</a>
				</div>
			</div>
			...
			<div className='footer-bottom'>
				<p>© {new Date().getFullYear()} RAAVITO. All rights reserved. | Home-cooked meals delivered with love ❤️</p>
			</div>
		</footer>
	);
};
