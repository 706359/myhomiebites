        ...
        <div className={styles.grid}>
          <div className={styles.content}>
            ...
            <p className={styles.description}>
              Order your meals easily, track deliveries, and enjoy a smooth experience — all from
              one simple app. Available for both iOS and Android.
            </p>
