      ...
      <div className='container special-offer reveal in' data-animate=''>
        <div className='special-offer-content'>
          <div className='special-offer-text'>
            ...
            <p>
              Subscribe for a full week (7 days) and get <strong>5% OFF</strong> on your total bill!
              Perfect for busy professionals and families.
            </p>
            <p>
              Subscribe for a full month and get <strong>7% OFF</strong> on your total bill! Perfect
