		...
		<section className='aboutSection'>
			<div className='aboutContainer'>
				...
				<p>
					...
					<strong>A1-405, Panchsheel Greens</strong>, we deliver daily tiffins throughout
					the neighborhood.
				</p>
				<p>
				...
				<p>
					Founded in <strong>Feb 2024</strong>, our mission is to provide busy
					professionals and families with convenient access to healthy, home-style meals
